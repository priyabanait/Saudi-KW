    ...
    <div className="flex justify-center items-center min-h-full mt-20 lg:mt-40 bg-[#f5f6f8] px-4">
      <div className="bg-white rounded-2xl shadow max-w-full w-full overflow-hidden lg:max-w-full lg:mx-50 border border-gray-200">
        <div className="flex flex-col lg:flex-row items-start p-6 lg:p-2 gap-8">
          ...
          <Image
  src="/agentdetail1.jpg"
  alt="Sandi Hill"
  width={260}
  height={260}
  className="w-28 h-28 md:w-72 md:h-72 rounded-full object-cover"
/>
          ...
          {/* Agent Info */}
          <div className="flex-1 space-y-2 lg:ml-20 w-full lg:w-auto  md:items-center lg:text-center mt-4 lg:mt-4">
            <h2 className="text-2xl lg:text-4xl font-semibold text-gray-800 md:ml-0 ml-20">Sandi Hill</h2>
            <p className="text-lg md:ml-0 ml-6">Keller Williams Frisco Stars</p>

            <div className="flex items-center text-base font-normal justify-center lg:justify-right gap-2">
              <MapPin size={16} className='mt-1'/> Frisco, TX 
...
/>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-xl text-gray-800 font-semibold">
            <User size={18} /> Sandi Hill
          </div>
          <p className="ml-6">
            Director of Operations at SWR Group @ Keller Williams® | REALTOR®
          </p>
          <p className="text-xs ml-6 text-gray-500">0740430</p>
          <p className="flex items-center gap-2 ml-6 text-sm">
            <Phone size={16} /> Mobile (214) 277-4761
          </p>
          <p className="flex items-center gap-2 ml-6 text-sm">
            <Mail size={16} /> sandihill@kw.com
          </p>
