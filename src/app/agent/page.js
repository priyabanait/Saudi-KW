        ...
        <div className="space-y-6 md:pr-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            {agents.map((agent, idx) => (
              <article
                key={idx}
                className="bg-gray-200 p-4 rounded-xl shadow-md flex flex-col sm:flex-row items-start gap-4 relative hover:shadow-lg transition-shadow"
              >
                {/* Agent Image */}
                <div className="w-32 h-32 md:w-32 md:h-32 flex-shrink-0 relative">
                  <Image 
                    ...
                    width={128}  // matches w-32 = 8rem = 128px
                    height={128} // matches h-32 = 8rem = 128px
