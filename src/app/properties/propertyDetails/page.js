...
const PropertyDetails = () => {
  ...
  <a href='/properties' className="text-[0.6rem] text-red-700">Back to Search</a>
</div>

        {/* Right Arrow */}
       <div className="flex items-center gap-2 md:mb-6 mb-6 cursor-pointer hover:text-gray-600">
  <span className="text-[0.6rem] text-red-700">View Next Listing</span>
  ...
  <hr className="w-50 md:w-60 mx-auto bg-red-500 h-[1.5px]" />
    {/* Main Info Box */}
...
<hr className="w-50 md:w-60 mx-auto bg-red-500 h-[1.5px]" />
 ...
 <div className="bg-gray-100 pt-20 pb-6 px-6 rounded-xl text-center">
              <h3 className="mt-4 font-semibold text-red-600 text-sm">AGENT DETAILS</h3>
              <div className="mt-6 flex justify-center">
                <div className="w-[1px] bg-red-600"></div>
                <div className="text-left pl-4">
                  <p className="text-xs font-bold text-red-600 mb-2">NAME</p>
                  <p className="text-sm">Meshary</p>
                  <p className="text-sm mb-2">Almalki</p>
                  <p className="text-xs font-bold text-red-600 mb-2 mt-2 md:mt-6">CONTACT</p>
                  <p className="text-sm mb-2">+966 123456789</p>
                   <p className="text-xs font-bold text-red-600 mb-2 mt-2 md:mt-6">Market Center</p>
                  <p className="text-sm">Jasmin</p>
                  <p className="text-xs font-bold text-red-600 mb-2 mt-2 md:mt-6">CITY</p>
